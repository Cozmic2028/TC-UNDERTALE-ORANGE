function Flag_Custom() {
	Flag_Set(FLAG_TYPE.STATIC,FLAG_STATIC.NAME,"Odin");
	...
	Flag_Set(FLAG_TYPE.STATIC,FLAG_STATIC.ATK,15);
	Flag_Set(FLAG_TYPE.STATIC,FLAG_STATIC.DEF,17);
	Flag_Set(FLAG_TYPE.STATIC,FLAG_STATIC.SPD,2);
	Flag_Set(FLAG_TYPE.STATIC,FLAG_STATIC.INV,40);
	Flag_Set(FLAG_TYPE.STATIC,FLAG_STATIC.BATTLE_MENU_FIGHT_OBJ,battle_menu_fight_toughglove);
	Flag_Set(FLAG_TYPE.STATIC,FLAG_STATIC.SLITHERS_IN_PARTY,0)
	...
	Item_SetWeapon(item_tough_glove);
	Item_SetArmor(item_manly_bandana);
	Item_Add(item_cozmo);
