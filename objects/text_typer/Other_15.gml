...
_group_voice[2,0]=snd_text_voice_slithers;
_group_voice[3,0]=snd_text_voice_don;
_group_voice[4,0]=snd_text_voice_aiden;

_group_face[0]=face;
_group_face[1]=face_slithers_neutral;
_group_face[2]=face_slithers_happy;
_group_face[3]=face_slithers_meh;
_group_face[4]=spr_face_don_neutral;
_group_face[5]=spr_face_aiden_neutral;